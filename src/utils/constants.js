export const CATS = [
  { key: 'AB',      label: 'AB',       accent: '#C49A47' },
  { key: 'C',       label: 'C',        accent: '#A8763E' },
  { key: 'ABC',     label: 'ABC',      accent: '#8C5E3C' },
  { key: 'D',       label: 'D',        accent: '#6E8B5B' },
  { key: 'taksai',  label: 'ตกไซต์',   accent: '#B5654A' },
  { key: 'sutthai', label: 'สุดท้าย',  accent: '#7C7250' },
